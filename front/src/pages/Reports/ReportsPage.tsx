...
export default function EvaluationForm() {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      // Forzar la transición a la sección de comentarios
  ...
  const handlePrevious = () => {
    if (currentQuestion > 0) {
      ...
      // Si estamos en comentarios y hacemos clic en anterior, volvemos a la última pregunta
  ...
  // Calcular progreso incluyendo la sección de comentarios
  const totalSteps = questions.length + 1;
  const currentStep = showCommentsSection ? questions.length + 1 : currentQuestion + 1;
                    ...
                    <Button
                      ...
                      className={`px-8 py-4 text-lg ${
                        currentQuestion === questions.length - 1 
                          ? 'bg-gradient-to-r from-red-500 via-yellow-500 to-green-500 hover:from-red-600 hover:via-yellow-600 hover:to-green-600' 
                          : 'bg-red-600 hover:bg-red-700'
                      }`}
                    >
                      {currentQuestion === questions.length - 1 ? 'Siguiente' : 'Siguiente'}
